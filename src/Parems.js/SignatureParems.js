...
export default SignatureParems;
    ...
    <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      ...
      <div className="adddrinkbtn  ">
       ...
       <p ><input type="radio" name="flexRadioDefault" id="flexRadioDefault1"  /> <span className="adddrinkincre">Karachi</span></p>
         ...
         <Link to ={`/signature-boxes`} ><a href="#" style={{marginTop: '10px',height: '35px', width:'310px'}} className="btn btn-danger" onClick={OrderHandler}>
            Place Your Order
          </a></Link>
          <div>
